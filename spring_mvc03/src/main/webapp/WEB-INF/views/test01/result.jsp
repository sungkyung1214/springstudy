...
<body>
	...
	<h2>이미지 보기</h2>
	<img src="/resources/images/dd.jpg" style="width: 100px;"><br>
	권장사항 : <img src="resources/images/dd.jpg" style="width: 100px;"><br>
	<img src='<c:url value= "/resources/images/dd.jpg" />' style="width: 100px;"><br>
	권장사항 : <img src='<c:url value= "resources/images/dd.jpg" />' style="width: 100px;"><br>

	<hr>
	<!-- 이미지업로드 : cos 라이브러리 사용(MultipartRequest), spring 자체 지원 
				자체지원 넣을라면 라이브러리 넣어야함
				라이브러리는 pom.xml에 넣기 -->
